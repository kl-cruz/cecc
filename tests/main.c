...
void tests_ecc_mul(void)
{
	...
	for (i = 0; i < ecc_point_mul_secp256r1_tab_len; ++i) {
		assert_true(
				test_ecc_mul(ecc_point_mul_secp256r1_test_tab[i][0], ecc_point_mul_secp256r1_test_tab[i][1],
						ecc_point_mul_secp256r1_test_tab[i][2], ecc_point_mul_secp256r1_test_tab[i][3],ecc_point_mul_secp256r1_test_tab[i][4], &ec_secp256r1) == 0);
	}
}

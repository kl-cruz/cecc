...
#define SEATEST_PRINT_BUFFER_SIZE  80
...
#define assert_memory_equal(expected, actual, len) do { seatest_assert_memory_equal(expected, actual, len, __FUNCTION__, __LINE__); } while (0)

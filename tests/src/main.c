...
void tests_ecc_ECDSA_gen_signature(void)
{
	...
	for (i = 0; i < P_256_SHA_1_tab_len; ++i) {
		assert_true(
				test_ecdsa_gen_sig(P_256_SHA_1_tab[i][4], P_256_SHA_1_tab[i][0], P_256_SHA_1_tab[i][1], P_256_SHA_1_tab[i][5], P_256_SHA_1_tab[i][6],
						&ec_secp256r1) == 0);
...
void tests_ecc_ECDSA_val_signature(void)
{
	...
	for (i = 0; i < P_256_SHA_1_tab_len; ++i) {
		...
		assert_true(
				test_ecdsa_val_sig(P_256_SHA_1_tab[i][5], P_256_SHA_1_tab[i][6], P_256_SHA_1_tab[i][0], P_256_SHA_1_tab[i][2], P_256_SHA_1_tab[i][3],
						&ec_secp256r1) == 0);
